...
#
# Also GCC/Clang fastLog2 does
# 31 - builtin_clz <=> bsr + xor (from clz) + sub
...
when isMainModule:
  doAssert log2(high(uint32)) == 31
  doAssert log2(high(uint64)) == 63
  doAssert log2(0'u32) == 0
  doAssert log2(0'u64) == 0
